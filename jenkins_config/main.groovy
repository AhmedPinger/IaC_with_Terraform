        ...
        stage('Terraform Apply') {
            steps {
                script {
                    ...
                    sh "echo 'web_server ansible_ssh_host=${ipAddress} ansible_ssh_user=admin ansible_ssh_private_key_file=REPLACE_WITH_PATH_TO_KEY.pem' >> /tmp/IaC_with_Terraform/ansible/inventory.ini"
